...
public class LangBase {
    ...
    public String getLanguage() {
        try {
            Yaml yaml = new Yaml();
            BufferedReader br = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/resources/nucleus.yml"));
    ...
    private Map<String, String> loadLangFile(String Language) {
        ...
        try (InputStream langStream = new ClassPathResource("Language/" + Language + ".ini").getInputStream()) {
            ...
            Log.sendError("The Language [" + Language + "] Not Found! Please check your setting in [nucleus.yml]", 777);
            return null;
        }
